	...
	<div class="clearfix background" id="red-content">
		...
		<?php $data['forms']->openForm('red-login'); ?>
			...
			<p style="margin-top: 5px;padding:5px"><?php $this->getIMG('nodes/users/assets/img/godaddy-ssl.gif') ?></p>
			<p style="text-align: center; margin-top: 10px;"><input type="submit" id="button" name="register" value="Login" class="button cupid-green"></p>
