	...
	<!-- CONTENT START -->
	<div class="clearfix cc" id="red-content">
		<div id="red-login">
		<?php $data['forms']->openForm('red-login'); ?>
			...
			<p style="text-align: center; margin-top: 10px;"><input type="submit" id="button" name="register" value="Login" class="a cupid-green"></p>
