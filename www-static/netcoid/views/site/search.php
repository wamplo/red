...
<div class="o" id="red-content">
	...
	<div class="dz" style="width: 480px;">
		...
		<ul class="az">
			...
			<li><a class="di" href="#">Real Estate</a></li>
			<li><a class="di" href="#">Advertising</a></li>
			<li><a class="di" href="#">Transportation</a></li>
			<li><a class="di" href="#">Household</a></li>
			<li><a class="di" href="#">Lessons</a></li>
	...
	<div class="ec" style="width: 480px;">
		...
		<ul class="az">
			...
			<li><a class="di" href="#">Bicycle</a></li>
			<li><a class="di" href="#">Automobiles Parts</a></li>
			<li><a class="di" href="#">Motorcycle Parts</a></li>
		...
		<ul class="az">
			...
			<li><a class="di" href="#">Servers</a></li>
			<li><a class="di" href="#">Desktops Parts</a></li>
