	...
	<div class="clearfix" id="groups-content">
		...
		<?php if ($data['status']['status'] === 1): ?>
			...
			<?php foreach ($data['posts'] as $post): ?>
				...
				echo '<div class="dr" style="margin-right: 5px;">';
				echo '<span class="ds" id="count-reply">'.$post['count_reply'].'</span> ';

				if ($post['status'] == 2) {
					echo "<span>offer</span> ";
				}

				echo '</div><div style="word-wrap: break-word; width: 630px;" class="dr">';
