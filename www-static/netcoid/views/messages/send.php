...
<div style="width: 475px; border: 1px solid rgb(238, 238, 238); margin: 20px auto 0pt; padding: 10px 15px;" id="form-red-wmd" class="de"><?php $data['forms']->openForm('red-wmd'); ?>
	<ul>
