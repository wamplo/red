		...
		<ul>
			<?php foreach ($data['posts'] as $post): ?>
				...
				<?php if ($post['type'] === 'groups'): ?>
					<!-- POST -->
					<?php if ($post['post']['status'] == 0): ?>
						<li class="from-follow-gid" data-id="<?php echo $post['post']['PID'];?>"><i>In</i> <a class="di" href="/<?php echo $post['post']['username'] ?>"><?php echo $post['post']['groupname']; ?></a>, <a class="dj" href="/<?php echo $post['post']['username'] ?>"><?php echo $post['post']['name'] ?></a> <i>post</i> <a target="_blank" class="di" href="/post?id=<?php echo $post['post']['PID'] ?>"><?php echo $post['post']['title']; ?></a></li>
					<?php endif ?>

					<!-- OFFER -->
					<?php if ($post['post']['status'] == 1): ?>
						<li class="from-follow-gid" data-id="<?php echo $post['post']['PID'];?>"><i>In</i> <a class="di" href="/<?php echo $post['post']['username'] ?>"><?php echo $post['post']['groupname']; ?></a>, <a class="dj" href="/<?php echo $post['post']['username'] ?>"><?php echo $post['post']['name'] ?></a> <i>offers</i> <a target="_blank" class="di" href="/post?id=<?php echo $post['post']['PID'] ?>"><?php echo $post['post']['title']; ?></a></li>
					<?php endif ?>

					<!-- OFFER -->
					<?php if ($post['post']['status'] == 2): ?>
						<li class="from-follow-gid" data-id="<?php echo $post['post']['PID'];?>"><i>In</i> <a class="di" href="/<?php echo $post['post']['username'] ?>"><?php echo $post['post']['groupname']; ?></a>, <a class="dj" href="/<?php echo $post['post']['username'] ?>"><?php echo $post['post']['name'] ?></a> <i>requests</i> <a target="_blank" class="di" href="/post?id=<?php echo $post['post']['PID'] ?>"><?php echo $post['post']['title']; ?></a></li>
					<?php endif ?>				
				<?php endif ?>
