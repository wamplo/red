<div id="red-side-menu">
	<ul>
		<ul>
			<li class="cj"><?php $this->href('/dashboard',l('home')); ?></li>
			<li class="cg"><?php $this->href('/edit/profile',l('Profiledata')); ?></li>
			<li class="bl"><?php $this->href('/edit/frontbox',l('informationbox')); ?></li>
			<li class="br"><?php $this->href('/edit/connections',l('connectioncenter')); ?></li>
			<li class="cl"><?php $this->href('/edit/products',l('productlist')); ?></li>
			<li class="cl"><?php $this->href('/edit/products','List Post'); ?></li>
			<li class="bo"><?php $this->href('/beta/insights',l('insights')); ?>
