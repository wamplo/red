<div id="red-side-menu">
	<ul>
		<ul>
			<li class="cf"><?php $this->href('/dashboard',l('home')); ?></li>
			<li class="ca"><?php $this->href('/edit/profile',l('Profiledata')); ?></li>
			<li class="bh"><?php $this->href('/edit/frontbox',l('informationbox')); ?></li>
			<li class="bo"><?php $this->href('/edit/connections',l('connectioncenter')); ?></li>
			<li class="ch"><?php $this->href('/edit/products',l('productlist')); ?></li>
			<li class="ch"><?php $this->href('/edit/products','List Post'); ?></li>
			<li class="bk"><?php $this->href('/beta/insights',l('insights')); ?>
