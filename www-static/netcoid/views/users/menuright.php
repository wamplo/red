<div id="red-side-menu">
	<ul>
		<ul>
			...
			<li class="bn"><?php $this->href('/edit/frontbox',l('informationbox')); ?></li>
			<li class="bu"><?php $this->href('/edit/connections',l('connectioncenter')); ?></li>
			<li class="co"><?php $this->href('/edit/products',l('productlist')); ?></li>
			<li class="co"><?php $this->href('/edit/products','List Post'); ?></li>
			<li class="bq"><?php $this->href('/beta/insights',l('insights')); ?>
