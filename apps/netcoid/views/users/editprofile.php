		...
		<div class="users-left50 l form" id="red-wmd"><?php $data['forms']->openForm('red-wmd'); ?>
			<ul>
				...
				<div id="html-enabled" style="
				    ...
				    text-align: center;
				">HTML enabled</div>
				<textarea name="information" data-error="Username Anda Harus Berformat 6-20 Huruf atau Angka" class="t" id="wmd-input" style="width: 450px; height: 250px;"><?php echo $data['data']['information']; ?></textarea>
				</li>
